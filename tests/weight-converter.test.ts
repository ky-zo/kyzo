...
test('uses the requested native stops for pounds and kilograms', () => {
  ...
  assert.deepEqual(POUND_VALUES.slice(5, 14), [10, 15, 20, 25, 30, 35, 40, 45, 50])
  assert.deepEqual(POUND_VALUES.slice(14), [60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220])
